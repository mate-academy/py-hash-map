    ...
    def __setitem__(self, key, value):
        if self.length < self.t_hold:
            ...
            for item in temporary_storage:
                if item:
                    self.adding_item_complex(item[0], item[1])
            self.adding_item_complex(key, value)
