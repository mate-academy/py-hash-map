...
class Dictionary:
    ...
    def __setitem__(self,
                    key: Any,
                    value: Any) -> None:
        if len(self.dict_as_list
        ) - self.dict_as_list.count(()) == self.max_elements:
    ...
    def add_elem_in_dict(self, key: Any, value: Any) -> None:
    ...
    def search_element(self, key: Any) -> (int, None):
    ...
    def __len__(self) -> int:
        return len(self.dict_as_list) - self.dict_as_list.count(())
